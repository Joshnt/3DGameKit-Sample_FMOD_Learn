...
namespace Gamekit3D
{
    ...
    public class PlayerController : MonoBehaviour, IMessageReceiver
    {
        ...
        void FixedUpdate()
        {
            ...
            string movement = "Stand";
            if (m_ForwardSpeed > 4)
                movement = "Run";
            else if (m_ForwardSpeed > 0.5)
                movement = "Walk";

            FMOD.Studio.System system = FMODUnity.RuntimeManager.StudioSystem;
            system.setParameterByNameWithLabel("MC_Bewegung", movement);
        ...
        void PlayAudio()
        {
            ...
            {
                RuntimeManager.PlayOneShotAttached(emoteAttackPlayerEvent, gameObject);
            }
        }
