...
namespace Gamekit3D
{
    ...
    public class PlayerControllerEditor : Editor
    {
        ...
        SerializedProperty m_emoteAttackPlayerEventProp;
        SerializedProperty m_emoteJumpPlayerEventProp;
        ...
        GUIContent m_footstepPlayerEventContent = new GUIContent("Footstep FMOD Event", "");
        GUIContent m_hurtAudioPlayerEventContent = new GUIContent("Hurt FMOD Event", "");
        GUIContent m_landingPlayerEventContent = new GUIContent("Landing FMOD Event", "");
        GUIContent m_emoteDeathPlayerEventContent = new GUIContent("Death FMOD Event", "");
        GUIContent m_emoteAttackPlayerEventContent = new GUIContent("Attack FMOD Event", "");
        GUIContent m_emoteJumpPlayerEventContent = new GUIContent("Jump FMOD Event", "");
