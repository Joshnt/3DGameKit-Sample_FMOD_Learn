...
namespace Gamekit3D.GameCommands
{
    ...
    public class SendGameCommand : MonoBehaviour
    {
        ...
        public EventReference onSendEvent;
        ...
        public void Send()
        {
            ...
            StartCoroutine(PlayDelayedFMOD(onSendEvent, audioDelay));
        }
        ...
        protected IEnumerator PlayDelayedFMOD(EventReference eventName, float delaySeconds)
        {
            yield return new WaitForSeconds(delaySeconds);
            if (!eventName.IsNull)
                RuntimeManager.PlayOneShotAttached(eventName, gameObject);
        }
    }
